...
static void start_rotate(stack *s, int *smallest, int *delta, int *index)
{
...
static void	loop(stack *s, int *index, int *spot_holder, int value)
{
...
static void	rotate_back(stack *s, int *delta)
{
	while (*delta > 0)
	{
		fake_rra(s);
...
static void	find_spotholder(stack *s, int *index, int *spot_holder)
{
	*index = 0;
